...
<table width=1000 height=50 border=0>
	<tr>
		<td align=center style="color:#F4F3CC;font-size:14px;font-weight:bold;background-color:#007A4F;border-radius:5px;">[게시글_상세보기]</td>
	</tr>
</table>
...
<table width="1000" border="0" cellpadding="0" cellspacing="0">
	...
	%>
	<tr>
		<td width=50><%=rs_comment.getString("tb_id") %></td>
		<td width=660>
