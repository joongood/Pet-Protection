...
<table width=1000 height=50 border=0>
   <tr>
      <td align=center style="width:500px;font-size:14px;font-weight:bold; background-color:#007A4F;color:#F4F3CC;border-radius:5px;">[후기]</td>
   </tr>
</table>
...
<table width="1000" border="0" cellpadding="0" cellspacing="0">
   <tr>
      ...
      <td align="right">
			...
			<input name="search" value="<%=search%>" style="height:20px; width:230px;"> 
			<button style="background-color:#75773C; width:50px; border-radius:5px; color:#F0DEB4; color:white; cursor:pointer;">검색</button>
			</form>
		</td>
   </tr>
</table>
<table width="1000" border="0" cellpadding="0" cellspacing="0">
   <tr bgcolor="007A4F" height="30">
   	<td width="80" align="center" style="color:#F4F3CC"><b>번호</b></td>
...
%>
   <tr height=46>
		...
		<td width=40 align=center>
			...
			<%}else{ %>
			<img src="/upload2/<%=file1_s%>" width=38>
			<%} %>
		</td>
		<td>
