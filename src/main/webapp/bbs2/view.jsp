...
<table width=1000 height=50 border=0>
	<tr>
		<td align=center style="color:#F4F3CC;font-size:14px;font-weight:bold;background-color:#007A4F;border-radius:5px;">[후기]</td>
	</tr>
</table>
...
<table width="1000" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
			...
			<img src="/upload2/<%=file1%>">
			<%} %>
		</td>
	</tr>
	<%if(!file1.equals("")){ //첨부파일 존재 %>
	<tr height=26>
		<td colspan=3>● 첨부 : <a href="/upload2/<%=file1 %>" download><%=file1 %></a></td>
	</tr>
	<tr><td colspan=3 height=1 width=100% bgcolor="#d1dee2"></td></tr>
	<%} %>
	<tr><td colspan=3 height=1 width=100% bgcolor="#d1dee2"></td></tr>
